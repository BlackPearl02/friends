export const en = {
  ...
  landing: {
    ...
    prompts: [
      ...
      "Who is most likely to forget why they joined the call?",
      "Who is most likely to roast you with kindness?",
      "Who is most likely to bring snacks and zero plans?",
      'Who is most likely to say "one more round" first?',
      "Who is most likely to leave and rejoin for the drama?",
      "Who is most likely to know everyone's Discord status?",
      "Who is most likely to win the finale by accident?",
    ],
  ...
  privacy: {
    ...
    s8Title: "Changes",
    s8Body: "We may update this policy. The date at the top changes when we do.",
  },
  terms: {
    title: "Terms of Use",
    updated: "Last updated: 13 September 2026",
